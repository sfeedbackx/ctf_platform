...
import { createCtfInstance, getActiveInstance, getCtfs, stopCtfInstance, submitFlag, } from '../controller/ctfController.js';
import { jwtMiddleware } from '../middlewares/jwtMiddleware.js';
const ctfRoute = Router();
ctfRoute.get('/', getCtfs);
ctfRoute.post('/:id/instances', jwtMiddleware, createCtfInstance);
...
//# sourceMappingURL=ctfRoute.js.map